...
def FinalWindow():
    ...
    indivscores="the winner of the first individual event is"+str(IndivFirst)+"\nthe winner of the second individual event is"+str(IndivSecond)+"\nthe winner of the Third individual event is"+str(IndivThird)+"\nthe winner of the Fourth individual event is"+str(IndivFourth)+"\nthe winner of the Fifth individual event is"+str(IndivFifth)
...
def IndivScores():
    ...
    if tempvar==1:
        IndivOne=Indivplace.get()
        IndivFirst.append(IndivOne)

    elif tempvar==2:
        Two=Indivplace.get()
        IndivSecond.append(IndivTwo)
    elif tempvar==3:
        IndivThree=Indivplace.get()
        IndivThird.append(IndivThree)
    elif tempvar==4:
        IndivFour=Indivplace.get()
        IndivFourth.append(IndivFour)
    elif tempvar==5:
        IndivFive=Indivplace.get()
        IndivFifth.append(IndivFive)
...
def MainWindow():
    ...
    enterButton3 = tk.Button(window, text="Import Names From previous file",command=GetScores,height=2,width=30,bg="#B584f4")
...
def appendTeam():
    ...
    if TeamChoice=="Red Team" and len(Red)<5:
        ...
        WriteData()
        _msgBox()
    elif TeamChoice=="Choose Team":
        tk.messagebox.showinfo(title="Select Team",message="Select a team! ",icon="error")
...
def addplayer():
    ...
    if PlayerType==2:
        ...
        if IndivLength>20:
            ...
            if len(Name)==0:
                tk.messagebox.showinfo(title="empty name",message=" Please Enter A Valid Name",icon="error")
            else:
        ...
        tk.messagebox.showinfo(title="Enter Category",message=" Please Select Team or Individual",icon="error")
